  ...
  return (
    <>
      ...
      <p>
        ...
        application Ikuyo located at https://ikuyo.kenrick95.org (the "Service")
        operated by Ikuyo ("us", "we", or "our").
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "us" or "our") refers to Ikuyo.
          </p>
        </li>
        <li>
          <p>
            <strong>Service</strong> refers to the Ikuyo website and
            application.
          </p>
        </li>
        <li>
          <p>
            <strong>Terms of Service</strong> (also referred as "Terms") mean
      ...
      <p>
        ...
        Ikuyo's website and application for personal, non-commercial transitory
      ...
      <ul>
        ...
        <li>
          ...
          Ikuyo's website or application;
        </li>
        <li>
      ...
      <p>
        ...
        restrictions and may be terminated by Ikuyo at any time. Upon
      ...
      <p>
        ...
        accurate, complete, and current at all times. Incomplete, inaccurate, or
      ...
      <p>
        We reserve the right to terminate your use of the Service for violating
      ...
      <p>By posting Content to the Service, you grant us the right to:</p>
      <ul>
        <li>
          use, modify, publicly perform, publicly display, reproduce, and
          distribute such Content on and through the Service;
        </li>
        <li>use and disclose your identity in connection with such Content;</li>
        <li>
          use such Content for our business purposes, including for promoting
          and redistributing part or all of the Service.
        </li>
      </ul>
      <p>
        ...
        provided in these Terms, and (ii) your use of the Content does not
      ...
      <p>
        Our Service is provided on an "as is" and "as available" basis. Ikuyo
      ...
      <p>
        In no event shall Ikuyo or its suppliers be liable for any damages
        (including, without limitation, damages for loss of data or profit, or
        due to business interruption) arising out of the use or inability to use
        the materials on Ikuyo's website or application, even if Ikuyo or an
      ...
      <p>
        You agree to defend, indemnify, and hold harmless Ikuyo and its licensee
      ...
      <h2>Governing Law</h2>
      <p>
        These Terms shall be interpreted and governed by the laws of Singapore,
