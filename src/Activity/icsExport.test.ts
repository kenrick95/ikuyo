...
describe('activitiesToIcs', () => {
  test('should generate valid ICS content for activities with dates', () => {
    const activities = [
      {
        id: 'activity-1',
  ...
  test('should return empty string when no activities have dates', () => {
    const activities = [
      {
        id: 'activity-1',
        title: 'Visit Museum',
  ...
  test('should handle activities with origin and destination', () => {
    const activities = [
      {
        id: 'activity-1',
        title: 'Train to Lyon',
  ...
  test('should handle activities spanning multiple days', () => {
    const activities = [
      {
        id: 'activity-1',
  ...
  test('should handle activities with different start and end timezones', () => {
    const activities = [
      {
        id: 'activity-1',
  ...
  test('should include geo coordinates when available', () => {
    const activities = [
      {
        id: 'activity-1',
  ...
  test('should handle activities without location', () => {
    const activities = [
      {
        id: 'activity-1',
  ...
  test('should handle activities without description', () => {
    const activities = [
      {
        id: 'activity-1',
        title: 'Quick Errand',
  ...
  test('should generate unique UIDs for each activity', () => {
    const activities = [
      {
        id: 'activity-1',
        title: 'Activity 1',
  ...
  test('should include DTSTAMP in all events', () => {
    const activities = [
      {
        id: 'activity-1',
        title: 'Test Activity',
  ...
  test('should filter out activities with only start time', () => {
    const activities = [
      {
        id: 'activity-1',
  ...
  test('should filter out activities with only end time', () => {
    const activities = [
      {
        id: 'activity-1',
        title: 'Incomplete Activity',
  ...
  test('should handle mixed activities (some with dates, some without)', () => {
    const activities = [
      {
        id: 'activity-1',
  ...
  test('should use trip timezone when activity timezone is not specified', () => {
    const activities = [
      {
        id: 'activity-1',
        title: 'Activity',
  ...
  test('should generate calendar name without trip title', () => {
    const activities = [
      {
        id: 'activity-1',
        title: 'Activity',
  ...
  test('should handle very long text that needs line folding', () => {
  ...
  test('should handle destination same as origin', () => {
    const activities = [
      {
        id: 'activity-1',
  ...
  test('should include correct calendar metadata', () => {
    const activities = [
      {
        id: 'activity-1',
        title: 'Activity',
  ...
  test('should handle activities at midnight boundary', () => {
    const activities = [
      {
        id: 'activity-1',
